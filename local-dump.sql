...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: db_user
--
...
ALTER TABLE public.employees OWNER TO db_user;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: db_user
--
